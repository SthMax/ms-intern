...
当前档案没有可核对的公司项目代码；通用模型、数据库、Agent框架开源不等于公司项目开源。本轮未进行全网代码穷尽搜索。

**分布：4分1家（南方）、3分18家、2分2家（广发、永赢）、1分和5分各0家。** 样本本就筛选了有具体AI披露的公司，分布不能外推全行业。

## 逐家公司

| 公司 | 分数 | 最有参考价值的工作流及技术 | 得分理由／缺什么 | 依据 |
|---|---:|---|---|---|
| [易方达](COMP-002-efund.md) | **3** | EFundGPT企业平台、指数投研、研发辅助；另有ima基金研选Skill；内部训练/LoRA、LULU平台、DeepSeek；外部Skill有安装和API Key使用步骤 | 资料丰富但分散在不同项目；缺一条内部工作流的完整数据处理、Prompt、工具接口与校验说明，不能拼接成可复现系统。 | [FUND-004](../sources/FUND-004/original.md) · [FUND-101](../sources/FUND-101/original.md) · [FUND-102](../sources/FUND-102/original.md) · [FUND-103](../sources/FUND-103/original.md) · [FUND-109](../sources/FUND-109/original.md) |
