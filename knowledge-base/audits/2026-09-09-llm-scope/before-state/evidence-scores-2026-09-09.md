...
> 同日案例平衡补查：工银瑞信新增两条量化技术申请原件，资料分数3→4；汇添富镜像存在缺图，整体仍为3。见[审查](case-diversity-2026-09-09.md)。上方早先量化批次“未调整评分”描述仅指该批次。
...
**分布：4分3家（易方达、南方、工银瑞信）、3分16家、2分2家（广发、永赢）、1分和5分各0家。** 样本本就筛选了有具体AI披露的公司，分布不能外推全行业。
...
| [工银瑞信](COMP-013-icbc-credit-suisse.md) | **4（原3）** | MCTS因子搜索的盘面、槽点、回报与CUDA调度；另有自步集成债券违约预测完整链 | 4分限定量化技术方案的文档级原型重建；无公开源码、独立效果或FundGPT投产对应。 | [FUND-318](../sources/FUND-318/original.md) · [FUND-319](../sources/FUND-319/original.md) · [审查](case-diversity-2026-09-09.md) |
