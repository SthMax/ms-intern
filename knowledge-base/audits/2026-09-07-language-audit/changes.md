...
| FUND-093 | not verifiable | not verifiable | Chinese | [metadata.json](../../sources/FUND-093/metadata.json) · [retrieval-response.html](../../sources/FUND-093/retrieval-response.html) · [retrieval-response.md](../../sources/FUND-093/retrieval-response.md) | Registered article redirects to generic FX168 news portal; expected Harvest article absent |
...
| FUND-162 | translated | raw | Chinese | [full-visible-text.txt](../../sources/FUND-162/full-visible-text.txt) · [metadata.json](../../sources/FUND-162/metadata.json) · [original.md](../../sources/FUND-162/original.md) · [source.html](../../sources/FUND-162/source.html) | 原登记来源类型和核验范围保留；人工核验待完成 |
