...
# Supervisory Guidance on Model Risk Management — April 2026

[Official guidance](https://www.federalreserve.gov/frrs/guidance/supervisory-guidance-on-model-risk-management.htm).

## 原始来源存档与提取说明

[原始文件](../sources/REG-008/source.html) · [完整原语言提取文本](../sources/REG-008/original.md) · [获取元数据与校验值](../sources/REG-008/metadata.json)
...
原文语言为英语。网页提取重复了正文，并将出版方脚注 1–3 的定义标为 [^4]–[^6]；下文仅保留第一次出现的 I–VII 节及这三条脚注正文，原文措辞不变。代码块内脚注标记为提取标记；请据原始网页核对出版方编号。

## 原文摘录 / Original-language excerpts

### Sections I–VII (original English)
...
### Publisher footnote 1 — extracted definition [^4]
...
### Publisher footnote 2 — extracted definition [^5]
...
### Publisher footnote 3 — extracted definition [^6]
