# Regulation and Governance Evidence Map

## Public-source matrix

This is an inventory structure, not legal advice. Add a row only after verifying
the official text and current status.
...
## Internal-policy questions (do not infer from public law)
...
| Records management | Which prompts, outputs, approvals, and model/version metadata must be retained? | Records / Compliance | Open |  |
| Human supervision | Which outputs require review, maker-checker controls, or prohibition? | Business / Compliance | Open |  |
| Software licensing | Are model, dataset, and dependency licenses acceptable for intended commercial use? | Legal / OSS review | Open |  |
| Change management | What testing and approval are required for model, weights, prompts, retrieval corpus, or guardrail changes? | Technology / MRM | Open |  |

## Legal-research QA checklist

- Official source and exact provision captured.
- Publication, effective, amendment, and current-status dates checked.
- Applicability to this entity, service, user population, and deployment pattern
  treated as a question unless confirmed.
- Source wording separated from interpretation.
