# 基金公司工作流资料历史评分 — 2026-09-09

> 当前选材已进一步限定2026年与三类LLM量化任务；本表为跨年份历史底表，不作为2026入选结论。见[当前矩阵](quant-research-2026-09-09.md)。


> 同日量化研究新增论文与代码，详见[专项报告](quant-research-2026-09-09.md)；因数据、版本和输出链仍需复核，本轮未调整21家公司分数。

本表保留此前广义AI/LLM资料评价，不能整体作为严格LLM排名。用户已明确LLM范围，工银传统ML带来的4分上调已撤回；报告入选以[LLM范围说明](llm-report-scope-2026-09-09.md)为准。研究者判断；不更改原始来源证据等级。评分衡量材料对复制同类工作流的帮助，不评价公司真实AI能力或投资业绩。
