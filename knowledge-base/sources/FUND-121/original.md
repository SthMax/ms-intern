# Label Horizon Paradox — public demo documentation

> Original-language README reading copy, relative links pinned to commit. [Unmodified README](files/README.md); [selected code manifest](archive.json); [metadata](metadata.json). Code is research material, not an instruction to install or execute it. This is an independent public daily-frequency demo, not the paper experimental codebase.
...
> the paper's description (see [docs/blo.md](https://github.com/EFundAI/label-horizon-paradox/blob/81c8098acdab2b0008a10f88c7e47321207ad509/docs/blo.md#differences-from-the-paper)).
...
(see the layout in [docs/data.md](https://github.com/EFundAI/label-horizon-paradox/blob/81c8098acdab2b0008a10f88c7e47321207ad509/docs/data.md#data-layout)), or adapt the
...
[docs/search.md](https://github.com/EFundAI/label-horizon-paradox/blob/81c8098acdab2b0008a10f88c7e47321207ad509/docs/search.md#why-the-peak-is-broad-sample-size-compresses-the-horizon-gap)
...
[docs/blo.md](https://github.com/EFundAI/label-horizon-paradox/blob/81c8098acdab2b0008a10f88c7e47321207ad509/docs/blo.md) for method details and differences from the paper.
...
[docs/backtest.md](https://github.com/EFundAI/label-horizon-paradox/blob/81c8098acdab2b0008a10f88c7e47321207ad509/docs/backtest.md#simplifications--limitations) for the
...
- [docs/data.md](https://github.com/EFundAI/label-horizon-paradox/blob/81c8098acdab2b0008a10f88c7e47321207ad509/docs/data.md) — Data pipeline: Alpha158 factors, VWAP labels, factor preprocessing, data download.
- [docs/search.md](https://github.com/EFundAI/label-horizon-paradox/blob/81c8098acdab2b0008a10f88c7e47321207ad509/docs/search.md) — Brute-force horizon search and the IC ranking baseline.
- [docs/blo.md](https://github.com/EFundAI/label-horizon-paradox/blob/81c8098acdab2b0008a10f88c7e47321207ad509/docs/blo.md) — Bi-level optimization: method, writeback, and differences from the paper.
- [docs/backtest.md](https://github.com/EFundAI/label-horizon-paradox/blob/81c8098acdab2b0008a10f88c7e47321207ad509/docs/backtest.md) — Ladder backtest engine, optimizers, costs, index benchmarks.
- [docs/architecture.md](https://github.com/EFundAI/label-horizon-paradox/blob/81c8098acdab2b0008a10f88c7e47321207ad509/docs/architecture.md) — Code structure and module responsibilities.
...
constraints not modeled here (see [docs/backtest.md](https://github.com/EFundAI/label-horizon-paradox/blob/81c8098acdab2b0008a10f88c7e47321207ad509/docs/backtest.md#simplifications--limitations)
...
This project is released under the [MIT License](https://github.com/EFundAI/label-horizon-paradox/blob/81c8098acdab2b0008a10f88c7e47321207ad509/LICENSE).
