...
2026-09-08 范围修正：**4篇与基金AI／LLM应用研究直接相关，现已全部入库。** 华泰柏瑞已从用户保存的5页PDF补齐，见[入库核对报告](../../audits/2026-09-08-huatai-pdf/README.md)。 巴菲特、ETF资金流、受贿案3条只是来源页文末推荐，已从研究补抓任务中排除。[范围核对记录](../../audits/2026-09-08-wechat-scope/README.md)。

先前3篇保留原始HTML、中文Markdown和58个本地图片资源；新增华泰柏瑞保留用户PDF、中文正文和逐页提取文本，图片包含在PDF中。[正文保真核对](../../audits/2026-09-07-wechat-live/README.md)及此前请求失败记录保留为历史过程。
