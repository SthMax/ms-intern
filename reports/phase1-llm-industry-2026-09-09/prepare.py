...
refs={
'FUND-001':('2025-12-31；历史采购证据','大模型安全网关采购结果公告'),
'FUND-004':('2026年1月协会案例；PDF未注明修订日期','指数业务一体化平台与模型应用'),
'FUND-007':('2026-01-19协会目录；PDF未注明日期','PDF第8–9页；本地RAG、市场观点与因子辅助评价'),
'FUND-009':('协议未注明发布日期','智能理财助理服务协议与所用模型'),
'FUND-011':('2026年1月协会案例；PDF未注明日期','千询固收交易平台与文本处理'),
...
'FUND-115':('代码快照，版本见提交号','固定提交1058e1b；查询客户端与接口文档'),
'FUND-116':('无日期帮助文档；2026-09-09归档','PDF第8–10页查询示例与接口使用说明'),
...
'FUND-220':('2026-01-27协会目录；PDF未注明修订日期','PDF第5–11页；风险邮件提取、条款问答与规则平台'),
'FUND-251':('2026-08-20','中国基金报20家基金公司AI应用调研'),
'FUND-300':('2026-01-19协会目录；PDF未注明日期','PDF第4–7页；FinAgent分层与业务拆解'),
'FUND-304':('2025报告期；发布日期未独立确认','嘉实可持续投资报告；ESG数据与AI/NLP应用'),
...
'FUND-352':('2026-07-01协会目录；PDF未注明日期','永赢安全GPT邮件反钓鱼应用'),
'FUND-356':('2026-06-01','中欧公众号转载中国基金报；Skills与投研协作'),
'FUND-359':('2026-09-03','中国证券报原刊；文本处理与量化研究发展方向'),
'FUND-400':('2026-07-21','财联社；2026Q2非货公募规模，剔除ETF联接基金'),
'FUND-403':('2026年1月协会案例；PDF未注明日期','国泰组合平台；DeepSeek与文本处理模块'),
}
for i in range(1,17):
    sid=f'REG-{i:03d}'
