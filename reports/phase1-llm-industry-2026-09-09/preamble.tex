...
\hypersetup{colorlinks=true,linkcolor=teal,urlcolor=teal,bookmarksnumbered=true,pdftitle={基金公司LLM应用调研：模型任务、输入输出与实施条件},pdfauthor={MSIM China internship research},pdfsubject={2026 industry evidence, four LLM workflows, governance and Phase 2 handoff}}
\urlstyle{same}
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\small\sffamily\color{muted}基金公司 LLM 应用研究}
\fancyhead[R]{\small\sffamily\color{muted}PHASE 1 · 2026.09.09}
\fancyfoot[L]{\scriptsize\color{muted}基金公司LLM应用调研}
