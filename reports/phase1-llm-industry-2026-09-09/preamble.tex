...
\hypersetup{colorlinks=true,linkcolor=teal,urlcolor=teal,bookmarksnumbered=true,pdftitle={基金公司LLM应用与本地部署前期研究：Phase 1行业报告},pdfauthor={MSIM China internship research},pdfsubject={2026 industry evidence, four LLM workflows, governance and Phase 2 handoff}}
\urlstyle{same}
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\small\sffamily\color{muted}基金公司 LLM 应用研究}
\fancyhead[R]{\small\sffamily\color{muted}PHASE 1 · 2026.09.09}
\fancyfoot[L]{\scriptsize\color{muted}公开资料研究 · 供 mentor 与量化部门讨论}
...
\newcommand{\src}[1]{\hyperref[ref:#1]{\textcolor{teal}{\mbox{[#1]}}}\allowbreak\hspace{.08em}}
...
\newcommand{\referenceentry}[5]{\par\noindent\begin{minipage}{\linewidth}\label{ref:#1}\small\textbf{\color{navy}[#1] #2}\\{\footnotesize #3。#4。\href{#5}{原始出处}}\end{minipage}\par\vspace{6pt}}
