...
\hypersetup{colorlinks=true,linkcolor=teal,urlcolor=teal,bookmarksnumbered=true,pdftitle={大语言模型如何进入基金投研工作：Phase 1行业研究},pdfauthor={MSIM China internship research},pdfsubject={2026 industry evidence, four LLM workflows, governance and Phase 2 handoff}}
\urlstyle{same}
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\small\sffamily\color{muted}基金公司 LLM 应用研究}
\fancyhead[R]{\small\sffamily\color{muted}PHASE 1 · 2026.09.09}
\fancyfoot[L]{\scriptsize\color{muted}公开资料研究 · 供导师与量化部门讨论}
...
\newcommand{\referenceentry}[5]{\par\noindent\begin{minipage}{\linewidth}\label{ref:#1}\small\textbf{\color{navy}[\csname refnum@#1\endcsname] #2}\\{\footnotesize #3。#4。\href{#5}{原始出处}}\end{minipage}\par\vspace{6pt}}
