...
// 1 Cover
{
 ...
 txt(s,'MSIM China 实习项目',80,536,1000,40,25,colors.white);
...
{
 const s=slide('合规要求对应用设计的影响',{foot:'公开文件提供研究依据。MSIM内部制度、COD条件和具体用例分类仍需确认。'});
